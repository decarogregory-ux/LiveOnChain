    ...
    <>
      ...
      <main style={hero}>
        <div style={heroInner}>
          ...
          <p style={sub}>Tips go wallet-to-wallet instantly. No platform cut. No delays.</p>
      ...
      <section style={features}>
        ...
        <div style={featureGrid}>
          {[
            ['⚡','Instant Payments','Tips hit your wallet in seconds.'],
            ['🔒','Non-Custodial','Wallet-to-wallet. We never touch your money.'],
            ['🏆','Live Leaderboard','Animations and badges drive engagement.'],
            ['🌐','Any Token','Accept ETH, SOL, USDC and more.'],
            ['📊','Real Analytics','Track earnings and viewers in real time.'],
            ['🎨','Custom Overlays','Brand your stream with themes and effects.'],
          ].map(([icon,title,desc])=>(

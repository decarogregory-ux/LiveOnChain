    ...
    <>
      ...
      <div style={layout}>
        ...
        <div style={rightPanel}>
          ...
          {tab==='tip' && (
            <div style={{padding:isMobile ? 14 : 20,display:'flex',flexDirection:'column',gap:12}}>
              ...
              <textarea style={{...inp,height:70,resize:'none'}} placeholder="Message..." value={message} onChange={e=>setMessage(e.target.value)}/>
          ...
          {tab==='board' && (
            <div style={{padding:12,display:'flex',flexDirection:'column',gap:8}}>
              {leaderboard.map((item)=>(
                <div key={item.name} style={{display:'flex',alignItems:'center',gap:10,padding:'12px',background:'var(--surface2)',borderRadius:8}}>

    ...
    <>
      ...
      <nav style={nav}>
        ...
        <div style={{display:'flex',gap:12}}>
          ...
          <Link href="/dashboard"><button style={btnPrimary}>Start Streaming</button></Link>
        </div>
      </nav>
      <main style={hero}>
        <div style={heroInner}>
          ...
          <div style={stats}>
            {[['$0','Platform Cut'],[count.toLocaleString(),'Live Viewers'],['100%','Creator Earnings'],['<2s','Payment Speed']].map(([v,l])=>(
      ...
      <section style={features}>
        <h2 style={sectionTitle}>Built different. Built for creators.</h2>
        <div style={featureGrid}>
          {[
            ['⚡','Instant Payments','Tips hit your wallet in seconds. No waiting weeks for a payout.'],
            ['🔒','Non-Custodial','We never touch your money. Wallet-to-wallet, always.'],
            ['🏆','Live Leaderboard','Tip animations, badges, and leaderboards drive engagement.'],
            ['🌐','Any Token','Accept ETH, SOL, USDC — whatever your audience prefers.'],
            ['📊','Real Analytics','Track earnings, viewers, and engagement in real time.'],
            ['🎨','Custom Overlays','Brand your stream with themes, emotes, and effects.'],
          ].map(([icon,title,desc])=>(
